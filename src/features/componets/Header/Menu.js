...
export default function Menu() {
  ...
  return (
    <div className="grid w-full grid-cols-2 lg:grid-cols-4">
      <SubMenu key={1} subMenuTitle="web" subMenus={webs} />
      <SubMenu key={2} subMenuTitle="menu" subMenus={menus} />
      <SubMenu key={3} subMenuTitle="JavaScript" subMenus={javascripts} />
      <SubMenu key={4} subMenuTitle="project" subMenus={projects} />
    </div>
  );
}
